...
> **See [`DELIVERABLES.md`](DELIVERABLES.md)** for the single-source table of all 46 Annex C numbered documents (plus doc 27 Release Note), including document names, phase mapping, role assignments (Written By, 1st Check, 2nd Check), and template file paths.
...
**NOTE**: Annex C Table C.1 is *informative*, not normative. The normative SIL requirements for individual documents are in the corresponding Section 7.x clauses.

---

### Normative Override — Planning Documents

**IMPORTANT — Normative "shall" requirements override Annex C informative SIL columns**: The planning documents (Annex C items 1–5) carry "HR" in Annex C (Table C.1, which is *informative*). However, the following normative clauses use "shall" and impose binding obligations regardless of SIL level:
...
- **Item 1 (SQAP)** is written by **VER** under §6.5.4.3; Annex C "Written by" column is blank for item 1
- **Item 2** (Software Quality Assurance Verification Report) was missing from older versions — now included in DELIVERABLES.md
...
- **Item 27** (Release Note) — normative §7.7.4.12 output; listed in DELIVERABLES.md as doc 27. Distinct from "Release Notes" (plural, item 38, deployment phase)
...
### Phase-by-Phase Document Details

> **See [`DELIVERABLES.md`](DELIVERABLES.md)** for the complete per-phase document table including document names, role assignments, and template paths for all Annex C items.

The phase gate commands for each phase are listed in the Quick Reference Table above. For full gate checklists and COD enforcement behavior, see `.opencode/agents/cod.md`.
