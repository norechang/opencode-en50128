...
| Field | Value |
|-------|-------|
| **Document ID** | DOC-SYS-ARCH-YYYY-NNN |
| **Version** | 1.0 |
| **Date** | YYYY-MM-DD |
...
- Replace YYYY-MM-DD with your project dates
- Replace YYYY-NNN with your document ID (e.g., 2026-001)
- This is a SAMPLE document showing a real Train Door Control System architecture
- Use this as a reference example for your own system architecture
- Keep the structure and technical approach, adapt the content to your system
-->
...
|---------|------|--------|---------|-------------|
| 0.1 | YYYY-MM-DD | System Architect | Initial architecture draft | - |
| 0.5 | YYYY-MM-DD | System Architect | Review updates, safety architecture | Technical Lead, Safety Manager |
| 1.0 | YYYY-MM-DD | System Architect | Approved baseline | Project Manager, Chief Engineer |
...
|------|------|-----------|------|
| **System Architect** | [Name] | [Signed] | YYYY-MM-DD |
| **Safety Manager** | [Name] | [Signed] | YYYY-MM-DD |
| **Hardware Lead** | [Name] | [Signed] | YYYY-MM-DD |
| **Software Lead** | [Name] | [Signed] | YYYY-MM-DD |
...
**Note**: Detailed software architecture is specified in **Software Architecture Specification (DOC-SAS-YYYY-NNN)**. This section provides system-level context for software allocation.
...
- **Software Architecture Specification** (DOC-SAS-YYYY-NNN) [To be developed]
- **Hardware Design Specification** (DOC-HW-DES-YYYY-NNN) [To be developed]
...
**Configuration Item ID**: CI-SYS-ARCH-NNN  
