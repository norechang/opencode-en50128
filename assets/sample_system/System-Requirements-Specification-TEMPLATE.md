...
| Field | Value |
|-------|-------|
| **Document ID** | DOC-SYS-REQ-YYYY-NNN |
| **Version** | 1.0 |
| **Date** | YYYY-MM-DD |
...
- This is a SAMPLE document showing a real Train Door Control System
- Use this as a reference example for your own system requirements
- Keep the structure and approach, adapt the content to your system
-->
...
|---------|------|--------|---------|-------------|
| 0.1 | YYYY-MM-DD | System Engineer | Initial draft | - |
| 0.5 | YYYY-MM-DD | System Engineer | Review updates | Technical Lead |
| 1.0 | YYYY-MM-DD | System Engineer | Approved baseline | Project Manager, Safety Authority |
...
| **Technical Lead** | [Name] | [Signed] | YYYY-MM-DD |
| **Project Manager** | [Name] | [Signed] | YYYY-MM-DD |
| **Customer Representative** | [Railway Authority] | [Signed] | YYYY-MM-DD |
...
See **Software Requirements Specification (DOC-SRS-YYYY-NNN)** for detailed software requirements.
...
See **System Architecture Description (DOC-SYS-ARCH-YYYY-NNN)** for detailed architecture.
...
- **Hardware Requirements Specification** (DOC-HW-REQ-YYYY-NNN)
...
**Configuration Item ID**: CI-SYS-REQ-NNN  
