...
| C header template (.h stub) | `templates/C-Header-Template.h` |
| C module template (.c stub) | `templates/C-Module-Template.c` |
...
4. **Load templates** `templates/C-Header-Template.h` and `templates/C-Module-Template.c`
