...
| SAS template (item 9) | `templates/Software-Architecture-Specification-template.md` |
| SDS template (item 10) | `templates/Software-Design-Specification-template.md` |
| SIS template (item 11) | `templates/Software-Interface-Specifications-template.md` |
| Component Design Spec template (item 15) | `templates/Software-Component-Design-Specification-template.md` |
...
4. **Load the SAS template** from `templates/Software-Architecture-Specification-template.md`.
...
2. **Load the SDS template** from `templates/Software-Design-Specification-template.md`
   and the SIS template from `templates/Software-Interface-Specifications-template.md`.
...
2. **Load the Component Design Spec template** from
   `templates/Software-Component-Design-Specification-template.md`.
