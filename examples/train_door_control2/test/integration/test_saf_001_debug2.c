...
int main(void) {
    printf("Running TC-INT-SAF-001 with more debug...\n\n");
    ...
    printf("Initializing fault detection...\n");
    ...
    printf("Critical fault active: %d\n", fault_detection_is_critical_fault_active(&fault));
